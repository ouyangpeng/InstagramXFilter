 ...
 * 日出滤镜
 */
class GPUImageSunRiseFilter :
    GPUImageBlendFilter(NO_FILTER_VERTEX_SHADER, readShaderFromRawResource(R.raw.sunrise)!!) {
    ...
    override fun onInitialized() {
        ...
        runOnDraw {
            ...
            mMaskGrey1TextureId = loadTexture(
                GPUImageParams.sContext!!,
                "filter/amaro_mask1.jpg",
                OpenGlUtils.NO_TEXTURE
            )
            GLES20.glActiveTexture(GLES20.GL_TEXTURE5)
            mMaskGrey2TextureId = loadTexture(
                GPUImageParams.sContext!!,
                "filter/amaro_mask2.jpg",
                OpenGlUtils.NO_TEXTURE
            )
            GLES20.glActiveTexture(GLES20.GL_TEXTURE6)
            mMaskGrey3TextureId = loadTexture(
                GPUImageParams.sContext!!,
                "filter/toy_mask1.jpg",
                OpenGlUtils.NO_TEXTURE
            )
        }
    }
