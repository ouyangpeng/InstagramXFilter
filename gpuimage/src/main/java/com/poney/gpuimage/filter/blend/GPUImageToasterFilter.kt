...
class GPUImageToasterFilter : GPUImageBlendFilter(
    ...
    override fun onInitialized() {
        ...
        runOnDraw {
            ...
            inputTextureHandles[2] =
                loadTexture(GPUImageParams.sContext!!, "filter/toastercurves.png")
            inputTextureHandles[3] =
                loadTexture(GPUImageParams.sContext!!, "filter/toasteroverlaymapwarm.png")
            inputTextureHandles[4] =
                loadTexture(GPUImageParams.sContext!!, "filter/toastercolorshift.png")
        }
    }
}