...
class GPUImageNostalgiaFilter :
    GPUImageBlendFilter(NO_FILTER_VERTEX_SHADER, readShaderFromRawResource(R.raw.nostalgia)!!) {
    private var mBlurSizeUniformLocation = 0
    ...
    private var mToneCurveTextureUniformLocation2 = 0
