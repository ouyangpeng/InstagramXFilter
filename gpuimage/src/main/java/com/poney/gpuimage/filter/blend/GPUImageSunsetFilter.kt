...
class GPUImageSunsetFilter :
    GPUImageBlendFilter(NO_FILTER_VERTEX_SHADER, readShaderFromRawResource(R.raw.sunset)!!) {
    ...
    override fun onInitialized() {
        ...
        runOnDraw {
            ...
            mMaskGrey1TextureId = loadTexture(GPUImageParams.sContext!!, "filter/rise_mask1.jpg")
            mMaskGrey2TextureId = loadTexture(GPUImageParams.sContext!!, "filter/rise_mask2.jpg")
        }
    }
}