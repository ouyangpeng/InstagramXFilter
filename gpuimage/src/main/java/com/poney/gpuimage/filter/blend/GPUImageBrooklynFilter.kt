...
class GPUImageBrooklynFilter :
    GPUImageBlendFilter(NO_FILTER_VERTEX_SHADER, readShaderFromRawResource(R.raw.brooklyn)!!) {
    ...
    override fun onInitialized() {
        ...
        runOnDraw {
            inputTextureHandles[0] =
                loadTexture(GPUImageParams.sContext!!, "filter/brooklynCurves1.png")
            inputTextureHandles[1] =
                loadTexture(GPUImageParams.sContext!!, "filter/filter_map_first.png")
            inputTextureHandles[2] =
                loadTexture(GPUImageParams.sContext!!, "filter/brooklynCurves2.png")
        }
    }
}