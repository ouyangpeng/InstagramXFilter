...
class GPUImageSutroFilter :
    GPUImageBlendFilter(NO_FILTER_VERTEX_SHADER, readShaderFromRawResource(R.raw.sutro)!!) {
    ...
    override fun onInitialized() {
        ...
        runOnDraw {
            inputTextureHandles[0] =
                loadTexture(GPUImageParams.sContext!!, "filter/vignette_map.png")
            inputTextureHandles[1] = loadTexture(GPUImageParams.sContext!!, "filter/sutrometal.png")
            inputTextureHandles[2] = loadTexture(GPUImageParams.sContext!!, "filter/softlight.png")
            inputTextureHandles[3] =
                loadTexture(GPUImageParams.sContext!!, "filter/sutroedgeburn.png")
            inputTextureHandles[4] =
                loadTexture(GPUImageParams.sContext!!, "filter/sutrocurves.png")
        }
    }
}