...
class GPUImageTenderFilter :
    GPUImageBlendFilter(NO_FILTER_VERTEX_SHADER, readShaderFromRawResource(R.raw.tender)!!) {
    ...
    override fun onInitialized() {
        ...
        runOnDraw {
            ...
            mMaskGrey1TextureId =
                loadTexture(GPUImageParams.sContext!!, "filter/bluevintage_mask1.jpg")
        }
    }
}