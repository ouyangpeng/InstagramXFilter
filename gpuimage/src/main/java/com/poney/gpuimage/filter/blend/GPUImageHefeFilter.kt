...
class GPUImageHefeFilter :
    GPUImageBlendFilter(NO_FILTER_VERTEX_SHADER, readShaderFromRawResource(R.raw.hefe)!!) {
    ...
    override fun onInitialized() {
        ...
        runOnDraw {
            inputTextureHandles[0] = loadTexture(GPUImageParams.sContext!!, "filter/edgeburn.png")
            inputTextureHandles[1] = loadTexture(GPUImageParams.sContext!!, "filter/hefemap.png")
            inputTextureHandles[2] = loadTexture(GPUImageParams.sContext!!, "filter/hefemetal.png")
            inputTextureHandles[3] =
                loadTexture(GPUImageParams.sContext!!, "filter/hefesoftlight.png")
        }
    }
}