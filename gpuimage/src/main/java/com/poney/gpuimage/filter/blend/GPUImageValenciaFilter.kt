...
class GPUImageValenciaFilter :
    GPUImageBlendFilter(NO_FILTER_VERTEX_SHADER, readShaderFromRawResource(R.raw.valencia)!!) {
    ...
    override fun onInitialized() {
        ...
        runOnDraw {
            inputTextureHandles[0] =
                loadTexture(GPUImageParams.sContext!!, "filter/valenciamap.png")
            inputTextureHandles[1] =
                loadTexture(GPUImageParams.sContext!!, "filter/valenciagradientmap.png")
        }
    }
}