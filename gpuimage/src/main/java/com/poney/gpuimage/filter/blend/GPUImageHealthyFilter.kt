...
class GPUImageHealthyFilter :
    GPUImageBlendFilter(NO_FILTER_VERTEX_SHADER, readShaderFromRawResource(R.raw.healthy)!!) {
    ...
    override fun onInitialized() {
        ...
        runOnDraw {
            ...
            mMaskGrey1TextureId =
                loadTexture(GPUImageParams.sContext!!, "filter/healthy_mask_1.jpg")
        }
    }
