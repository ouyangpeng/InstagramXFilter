...
class GPUImageAmaroFilter :
    GPUImageBlendFilter(NO_FILTER_VERTEX_SHADER, readShaderFromRawResource(R.raw.amaro)!!) {
    ...
    override fun onInitialized() {
        ...
        runOnDraw {
            ...
            inputTextureHandles[2] = loadTexture(GPUImageParams.sContext!!, "filter/amaromap.png")
        }
    }
}