...
open class GPUImageLookupFilter(protected var table: String) : GPUImageBlendFilter(
    NO_FILTER_VERTEX_SHADER, LOOKUP_FRAGMENT_SHADER
) {
    ...
    override fun onInitialized() {
        super.onInitialized()
        runOnDraw {
            mLookupSourceTexture =
                loadTexture(GPUImageParams.sContext!!, table, OpenGlUtils.NO_TEXTURE)
        }
    }
